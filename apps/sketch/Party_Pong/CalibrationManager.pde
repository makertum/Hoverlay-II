class CalibrationManager {
  ...
  float[] dewarp(float[] _prewarped){
    float[] dewarped= new float[3];
    dewarped[2]=_prewarped[2]/scaling[2]-translation[2];
    dewarped[1]=_prewarped[1]/scaling[1]/zFix/dewarped[2]-translation[1];
    dewarped[0]=_prewarped[0]/scaling[0]/zFix/dewarped[2]-translation[0];
    return dewarped;
  }
