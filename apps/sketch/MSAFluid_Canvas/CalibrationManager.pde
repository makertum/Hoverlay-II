class CalibrationManager {
  ...
  void saveSettings() {
    saveStrings(translationPath, stringifyFloats(translation));
    saveStrings(scalingPath, stringifyFloats(scaling));
    saveStrings(rotationPath, stringifyFloats(rotation));
  ...
  String[] stringifyFloats(float[] floats) {
